...
media_js=( '%sadmin/js/jquery.js'%settings.STATIC_URL,
           '%sadmin/js/jquery.autocomplete.js'%settings.STATIC_URL, )
...
class ForeignKeySearchInput( forms.HiddenInput ):
	...
	def render( self, name, value, attrs = None ):
		...
		return SafeUnicode( rendered+u'''
			...
			<a class="deletelink" title="Delete" onclick="autocomplete_delete(this)">&nbsp;</a>
		'''%{
